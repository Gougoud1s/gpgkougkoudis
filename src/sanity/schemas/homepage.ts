...
export const homepage = defineType({
  ...
  type: "document",
  fields: [
    defineField({ name: "showTrustBar", title: "Εμφάνιση rating bar", type: "boolean", initialValue: true }),
    defineField({ name: "showFeaturedCollections", title: "Εμφάνιση επιλεγμένων κατηγοριών", type: "boolean", initialValue: true }),
    defineField({ name: "showFeaturedProducts", title: "Εμφάνιση επιλεγμένων προϊόντων", type: "boolean", initialValue: true }),
    defineField({ name: "showFeaturedServices", title: "Εμφάνιση επιλεγμένων υπηρεσιών", type: "boolean", initialValue: true }),
    defineField({ name: "showInstagram", title: "Εμφάνιση Instagram", type: "boolean", initialValue: true }),
    defineField({ name: "showStory", title: "Εμφάνιση Story", type: "boolean", initialValue: true }),
    defineField({ name: "showReviews", title: "Εμφάνιση κριτικών", type: "boolean", initialValue: true }),
    defineField({ name: "showVisit", title: "Εμφάνιση Επισκεφθείτε μας", type: "boolean", initialValue: true }),
